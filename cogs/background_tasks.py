...
class BackgroundTasks(Cog):
    ...
    def handle_price_tracking_error(self, e: Exception, is_osrs: bool, status: int | None = None, delay_before_retry: int | None = 600) -> None:
        ...
        ignored_error_types_on_first_occurrence: list[str | int] = ['TimeoutError', 'ClientConnectorError', 'ClientOSError', 'ClientConnectionResetError', 200, 500, 502, 504, 522] # Expected errors from RS API that are not alarming unless repeated
